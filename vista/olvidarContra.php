...
<body class="text-center" style="background-image: url('img/viejalogin.jpg');">
  ...
  la accion act_login.php del controlador cuando se oprima el boton Iniciar Sesión -->
	<form class="form-signin" method="post" action="../PHPMailer-6.5.0/src/mail.php">
	...
	sería así $correo = $_GET['correo']-->
		...
		<label for="fechaDeNacimiento" class="sr-only ">Fecha Nacimiento</label>
		
		<div class="checkbox mb-3">
		</div>
		<button class="btn btn-lg btn-primary btn-block" type="submit">
			<h8>Recuperar Contraseña</h8>
		</button>
