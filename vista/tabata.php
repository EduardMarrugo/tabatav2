            ...
            <div class="p-4 p-lg-5 bg-light rounded-3 text-center">
                <div class="m-4 m-lg-5">
                    <h1 class="display-5 fw-bold">Bienvenido <?php
                                                                ...
                                                                ?></h1>
                    <p class="fs-4">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Distinctio tempora
                        accusantium veritatis neque aliquid ipsa eum.</p>
                </div>
            </div>
        </div>
    </header>
                    ...
                    <div class="card bg-light border-0 h-100">
                        <div class="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                            ...
                            <p class="mb-0">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repudiandae
                                consequatur, nisi error doloremque sit aspernatur.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-xxl-4 mb-5">
